-- Validate the public Martin boundary and retain location identity.
...
-- A committed revision gives tile URLs an identity across ETL publications.
CREATE TABLE public.map_dataset_revision (
  singleton BOOLEAN PRIMARY KEY DEFAULT TRUE CHECK (singleton),
  revision UUID NOT NULL DEFAULT gen_random_uuid()
);
INSERT INTO public.map_dataset_revision (singleton) VALUES (TRUE);
